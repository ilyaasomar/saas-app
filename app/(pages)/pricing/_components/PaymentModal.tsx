...
const deliveryMethods = [
  {
    id: 1,
    title: "Local Payment",
    turnaround: "Use local payments like eDahab, ZAAD, or Sahal.",
    price: "0",
    paymentType: "local",
  },
  {
    ...
    turnaround: "Use Stripe or a credit card.",
    price: "0",
    paymentType: "online",
  },
];
...
const paymentMethods = [
  ...
  },
  {
    ...
    id: 2,
    title: "Zaad",
    description: "Reliable for everyday transactions",
  },
  {
    code: "25290",
    phone: "",
    id: 3,
    title: "Sahal",
    description: "Easy and convenient payment solution",
  },
];
            ...
            <div className="mt-10">
              ...
              <div className="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                {deliveryMethods.map((method) => (
                  <div
                    className={`cursor-pointer rounded-lg border p-4 shadow-sm ${cn(
                ...
                <div className="mt-5 pt-5 sm:mt-6 w-full">
                  <button
                    ...
                    className={cn(
                      ...
                      `w-full inline-flex justify-center rounded-md border border-transparent  py-2 px-4 text-sm font-medium text-white shadow-sm  focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 disabled:cursor-wait
                                        `
                    )}
                  >
